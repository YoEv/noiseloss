...
\title{Intrinsic Signals of Generative Music Models Predict Human Evaluation of Musicality}
...
%   listening experience: prediction loss and entropy reflect expectation and surprise, 
%   while SAE latent features capture higher-level musical representations 
%   that align with human judgments of good versus bad music clips.
...
% We assume these signals partially capture the listening experience---
% prediction loss and entropy reflect expectation and surprise, 
% while SAE latent features capture higher-level musical representations that align 
% with human judgments of good versus bad music clips---and experiments on five 
% human-evaluation benchmarks spanning continuous ratings and pairwise preferences 
% confirm this correspondence:
% the temporal dynamics of loss and entropy
% track listeners' moment-to-moment anticipation and surprise,
% while SAE latent directions separate clips humans rate as good
% from those rated as bad---%
% with predictive and representational signals
% proving partially complementary.
We hypothesize that these signals partially capture the listening experience:
the temporal and frequency-domain structure of loss and entropy
reflect listeners' expectation and surprise,
while gradient directions in SAE latent space
separate clips humans rate as good from those rated as bad.
Experiments on five human-evaluation benchmarks
spanning continuous ratings and pairwise preferences
