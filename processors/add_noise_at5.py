...
def add_noise_at_5s(audio_data, sample_rate, token_length=5, db_level=-20, frame_rate=50):
...
def process_audio_file(input_path, output_path, token_length=5, db_level=-20, frame_rate=50):
    ...
    modified_audio = add_noise_at_5s(audio_data, sample_rate, token_length, db_level, frame_rate)
