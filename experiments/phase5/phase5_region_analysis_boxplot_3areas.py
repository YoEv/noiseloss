...
OUTPUT_DIR = "+Loss_Plot/Phase5_1/3regions_boxplot"
...
def plot_grouped_boxplot_on_axis(ax, all_group_results, group_meta, title):
    ...
    for g in groups_in_order:
        ...
        for patch in bp["boxes"]:
            patch.set_facecolor(group_meta[g]["color"])
...
def main():
    print("Starting region analysis (white noise, tk50/100/150/200, four models: Small / Medium / Melody / Large)...")
    ...
    plt.tight_layout()
    out_path = os.path.join(OUTPUT_DIR, "no_legend_avg_loss_diff_grouped_boxplot_white_4models_1x4.png")
